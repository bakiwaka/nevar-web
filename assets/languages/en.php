...
$lang = array(
    ...
    "nav_active" => "Most active users",
    "nav_features" => "Features",
    "nav_team" => "Team",
    "nav_faq" => "FAQ",

    // Home
    "home_title" => "Imagine a bot, ...",
    "home_subtitle" => "... who does all your work for you and simplifies your workflow as a Discord moderator to the maximum",
