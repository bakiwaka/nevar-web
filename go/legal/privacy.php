...
<head>
    ...
    <title><?=$lang["p_title"] ?></title>
    <meta content="<?=$lang["p_metadescription"] ?>" name="description">
...
<main id="main">
    ...
    <section class="breadcrumbs">
        <div class="container">
            <ol>
                <li><a href="/">Home</a></li>
                <li><?=$lang["p_breadcrumb_1"]; ?></li>
                <li><a href=""><?=$lang["p_breadcrumb_2"]; ?></a></li>
            </ol>
            <h2><?=$lang["p_breadcrumb_2"]; ?></h2>
        </div>
    </section>
    <!-- End Breadcrumbs -->
