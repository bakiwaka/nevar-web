...
<head>
    ...
    <title><?=$lang["t_title"] ?></title>
    <meta content="<?=$lang["t_metadescription"] ?>" name="description">
...
<main id="main">
    ...
    <section class="breadcrumbs">
        <div class="container">
            <ol>
                <li><a href="/">Home</a></li>
                <li><?=$lang["t_breadcrumb_1"]; ?></li>
                <li><a href=""><?=$lang["t_breadcrumb_2"]; ?></a></li>
            </ol>
            <h2><?=$lang["t_breadcrumb_2"]; ?></h2>
        </div>
    </section>
    <!-- End Breadcrumbs -->
